...
export class EditarEstablecimientosComponent implements OnInit {
  ...
  actualizarEstablecimiento() {
    ...
    // Crear el objeto de establecimiento con los valores del formulario y el ID del establecimiento a editar
    ...
    console.log('Datos enviados al PHP:', this.establecimiento);
    // Llamar al servicio para editar el establecimiento en el backend
